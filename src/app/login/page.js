      ...
      <div className="min-h-screen pt-32 pb-20 flex items-center justify-center bg-background px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-md w-full bg-white p-10 sm:p-12 rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.04)] border border-primary/5 relative z-10">
          ...
          <div className="w-full flex bg-slate-50/80 rounded-xl p-1 mb-8 border border-slate-100">
            <Link href="/login" className="flex-1 flex items-center justify-center py-3 rounded-lg bg-white shadow-[0_2px_8px_rgba(0,0,0,0.04)] text-xs uppercase tracking-widest font-bold text-primary transition-all">
              Login
            </Link>
            <Link href="/register" className="flex-1 flex items-center justify-center py-3 rounded-lg text-xs uppercase tracking-widest font-bold text-foreground/50 hover:text-primary transition-all">
              Sign Up
            </Link>
          </div>
          ...
          <div className="text-center mt-2">
            ...
            <p className="mt-4 text-sm text-foreground/60 font-light leading-relaxed">
              Sign in to access your curated wishlist, track custom orders, and manage your luxury gifting experience.
            </p>
          </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-secondary focus:ring-secondary border-primary/20 rounded cursor-pointer accent-secondary"
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-foreground/70 font-light cursor-pointer">
                  Remember me
                </label>
              </div>
