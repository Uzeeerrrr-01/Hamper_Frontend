  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-serif text-primary mb-2">Email Management</h1>
          <p className="text-foreground/60 text-sm">Manage and organize your email from here.</p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-secondary/10">
              <tr className="hover:bg-secondary/5 transition-colors">
                ...
                <td className="p-6 text-sm font-medium text-primary">Sample Email</td>
